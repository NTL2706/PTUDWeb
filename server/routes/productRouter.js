...
const uploadController = require("../middleware/uploadImg");
...
router.get("/delete-category/:id", product_controller.getDeleteCategory);
...
router.get("/edit-product/:id", product_controller.getEditProduct);

router.post("/edit-product", product_controller.postEditProduct);

router.get("/delete-product/:id", product_controller.getDeleteProduct);
